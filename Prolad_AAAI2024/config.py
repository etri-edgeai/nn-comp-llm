...
parser.add_argument('--data.test', type=str, default='All', metavar='TESTSETS', nargs='+',
...
parser.add_argument('--test.prolad-opt', type=str, choices=['alpha', 'beta', 'alpha+beta'], default='alpha+beta', metavar='PROLAD_OPT',
...
parser.add_argument('--out.dir', default='./checkpoints', type=str, metavar='PATH',
                    help='directory to output the result and checkpoints')
parser.add_argument('--out.method', default='weights', type=str, metavar='PATH',
